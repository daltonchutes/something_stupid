...
;--------------------------------------------------------
	...
	.globl _gbt_loop
	.globl _gbt_play
	.globl _SkateDisplayShowNext
	.globl _InitSkateDisplay
...
;numbers.c:45: }
	ret
;numbers.c:47: void InitSkateDisplay(){
;	---------------------------------
; Function InitSkateDisplay
; ---------------------------------
_InitSkateDisplay::
;numbers.c:48: set_sprite_tile(14, SkateArray[5]);
	ld	hl, #(_SkateArray + 10)
	ld	c, (hl)
;C:/Users/rutha/Documents/GitHub/something_stupid/gbdk/include/gb/gb.h:1447: shadow_OAM[nb].tile=tile;
	ld	hl, #(_shadow_OAM + 58)
	ld	(hl), c
;numbers.c:49: set_sprite_tile(15, SkateArray[5]);
	ld	hl, #(_SkateArray + 10)
	ld	c, (hl)
;C:/Users/rutha/Documents/GitHub/something_stupid/gbdk/include/gb/gb.h:1447: shadow_OAM[nb].tile=tile;
	ld	hl, #(_shadow_OAM + 62)
	ld	(hl), c
;numbers.c:50: set_sprite_tile(16, SkateArray[5]);
	ld	hl, #(_SkateArray + 10)
	ld	c, (hl)
;C:/Users/rutha/Documents/GitHub/something_stupid/gbdk/include/gb/gb.h:1447: shadow_OAM[nb].tile=tile;
	ld	hl, #(_shadow_OAM + 66)
	ld	(hl), c
;numbers.c:51: set_sprite_tile(17, SkateArray[5]);
	ld	hl, #(_SkateArray + 10)
	ld	c, (hl)
;C:/Users/rutha/Documents/GitHub/something_stupid/gbdk/include/gb/gb.h:1447: shadow_OAM[nb].tile=tile;
	ld	hl, #(_shadow_OAM + 70)
	ld	(hl), c
;numbers.c:52: set_sprite_tile(18, SkateArray[5]);
	ld	hl, #(_SkateArray + 10)
	ld	c, (hl)
;C:/Users/rutha/Documents/GitHub/something_stupid/gbdk/include/gb/gb.h:1447: shadow_OAM[nb].tile=tile;
...
;C:/Users/rutha/Documents/GitHub/something_stupid/gbdk/include/gb/gb.h:1521: itm->y=y, itm->x=x;
	...
	ld	(hl+), a
	ld	(hl), #0x28
;numbers.c:57: move_sprite(18, 40, 16);
;numbers.c:58: }
	ret
;numbers.c:60: void SkateDisplayShowNext(int stage){
;	---------------------------------
; Function SkateDisplayShowNext
; ---------------------------------
_SkateDisplayShowNext::
;numbers.c:61: switch(stage){
	ldhl	sp,	#2
	ld	a, (hl+)
	or	a, a
	or	a, (hl)
...
;numbers.c:62: case 0:
00101$:
;numbers.c:63: set_sprite_tile(14, SkateArray[5]);
	ld	hl, #(_SkateArray + 10)
	ld	c, (hl)
;C:/Users/rutha/Documents/GitHub/something_stupid/gbdk/include/gb/gb.h:1447: shadow_OAM[nb].tile=tile;
	ld	hl, #(_shadow_OAM + 58)
	ld	(hl), c
;numbers.c:64: set_sprite_tile(15, SkateArray[5]);
	ld	hl, #(_SkateArray + 10)
	ld	c, (hl)
;C:/Users/rutha/Documents/GitHub/something_stupid/gbdk/include/gb/gb.h:1447: shadow_OAM[nb].tile=tile;
	ld	hl, #(_shadow_OAM + 62)
	ld	(hl), c
;numbers.c:65: set_sprite_tile(16, SkateArray[5]);
	ld	hl, #(_SkateArray + 10)
	ld	c, (hl)
;C:/Users/rutha/Documents/GitHub/something_stupid/gbdk/include/gb/gb.h:1447: shadow_OAM[nb].tile=tile;
	ld	hl, #(_shadow_OAM + 66)
	ld	(hl), c
;numbers.c:66: set_sprite_tile(17, SkateArray[5]);
	ld	hl, #(_SkateArray + 10)
	ld	c, (hl)
;C:/Users/rutha/Documents/GitHub/something_stupid/gbdk/include/gb/gb.h:1447: shadow_OAM[nb].tile=tile;
	ld	hl, #(_shadow_OAM + 70)
	ld	(hl), c
;numbers.c:67: set_sprite_tile(18, SkateArray[5]);
	ld	hl, #(_SkateArray + 10)
	ld	c, (hl)
;C:/Users/rutha/Documents/GitHub/something_stupid/gbdk/include/gb/gb.h:1447: shadow_OAM[nb].tile=tile;
	ld	hl, #(_shadow_OAM + 74)
...
;numbers.c:69: case 1:
00102$:
;numbers.c:70: set_sprite_tile(14, SkateArray[0]);
	ld	hl, #_SkateArray
	ld	c, (hl)
;C:/Users/rutha/Documents/GitHub/something_stupid/gbdk/include/gb/gb.h:1447: shadow_OAM[nb].tile=tile;
	ld	hl, #(_shadow_OAM + 58)
	ld	(hl), c
;numbers.c:71: set_sprite_tile(15, SkateArray[5]);
	ld	hl, #(_SkateArray + 10)
	ld	c, (hl)
;C:/Users/rutha/Documents/GitHub/something_stupid/gbdk/include/gb/gb.h:1447: shadow_OAM[nb].tile=tile;
	ld	hl, #(_shadow_OAM + 62)
	ld	(hl), c
;numbers.c:72: set_sprite_tile(16, SkateArray[5]);
	ld	hl, #(_SkateArray + 10)
	ld	c, (hl)
;C:/Users/rutha/Documents/GitHub/something_stupid/gbdk/include/gb/gb.h:1447: shadow_OAM[nb].tile=tile;
	ld	hl, #(_shadow_OAM + 66)
	ld	(hl), c
;numbers.c:73: set_sprite_tile(17, SkateArray[5]);
	ld	hl, #(_SkateArray + 10)
	ld	c, (hl)
;C:/Users/rutha/Documents/GitHub/something_stupid/gbdk/include/gb/gb.h:1447: shadow_OAM[nb].tile=tile;
	ld	hl, #(_shadow_OAM + 70)
	ld	(hl), c
;numbers.c:74: set_sprite_tile(18, SkateArray[5]);
	ld	hl, #(_SkateArray + 10)
	ld	c, (hl)
;C:/Users/rutha/Documents/GitHub/something_stupid/gbdk/include/gb/gb.h:1447: shadow_OAM[nb].tile=tile;
	ld	hl, #(_shadow_OAM + 74)
...
;numbers.c:76: case 2:
00103$:
;numbers.c:77: set_sprite_tile(14, SkateArray[0]);
	ld	hl, #_SkateArray
	ld	c, (hl)
;C:/Users/rutha/Documents/GitHub/something_stupid/gbdk/include/gb/gb.h:1447: shadow_OAM[nb].tile=tile;
	ld	hl, #(_shadow_OAM + 58)
	ld	(hl), c
;numbers.c:78: set_sprite_tile(15, SkateArray[1]);
	ld	hl, #_SkateArray + 2
	ld	c, (hl)
;C:/Users/rutha/Documents/GitHub/something_stupid/gbdk/include/gb/gb.h:1447: shadow_OAM[nb].tile=tile;
	ld	hl, #(_shadow_OAM + 62)
	ld	(hl), c
;numbers.c:79: set_sprite_tile(16, SkateArray[5]);
	ld	hl, #(_SkateArray + 10)
	ld	c, (hl)
;C:/Users/rutha/Documents/GitHub/something_stupid/gbdk/include/gb/gb.h:1447: shadow_OAM[nb].tile=tile;
	ld	hl, #(_shadow_OAM + 66)
	ld	(hl), c
;numbers.c:80: set_sprite_tile(17, SkateArray[5]);
	ld	hl, #(_SkateArray + 10)
	ld	c, (hl)
;C:/Users/rutha/Documents/GitHub/something_stupid/gbdk/include/gb/gb.h:1447: shadow_OAM[nb].tile=tile;
	ld	hl, #(_shadow_OAM + 70)
	ld	(hl), c
;numbers.c:81: set_sprite_tile(18, SkateArray[5]);
	ld	hl, #(_SkateArray + 10)
	ld	c, (hl)
;C:/Users/rutha/Documents/GitHub/something_stupid/gbdk/include/gb/gb.h:1447: shadow_OAM[nb].tile=tile;
	ld	hl, #(_shadow_OAM + 74)
...
;numbers.c:83: case 3:
00104$:
;numbers.c:84: set_sprite_tile(14, SkateArray[0]);
	ld	hl, #_SkateArray
	ld	c, (hl)
;C:/Users/rutha/Documents/GitHub/something_stupid/gbdk/include/gb/gb.h:1447: shadow_OAM[nb].tile=tile;
	ld	hl, #(_shadow_OAM + 58)
	ld	(hl), c
;numbers.c:85: set_sprite_tile(15, SkateArray[1]);
	ld	hl, #_SkateArray + 2
	ld	c, (hl)
;C:/Users/rutha/Documents/GitHub/something_stupid/gbdk/include/gb/gb.h:1447: shadow_OAM[nb].tile=tile;
	ld	hl, #(_shadow_OAM + 62)
	ld	(hl), c
;numbers.c:86: set_sprite_tile(16, SkateArray[2]);
	ld	hl, #_SkateArray + 4
	ld	c, (hl)
;C:/Users/rutha/Documents/GitHub/something_stupid/gbdk/include/gb/gb.h:1447: shadow_OAM[nb].tile=tile;
	ld	hl, #(_shadow_OAM + 66)
	ld	(hl), c
;numbers.c:87: set_sprite_tile(17, SkateArray[5]);
	ld	hl, #(_SkateArray + 10)
	ld	c, (hl)
;C:/Users/rutha/Documents/GitHub/something_stupid/gbdk/include/gb/gb.h:1447: shadow_OAM[nb].tile=tile;
	ld	hl, #(_shadow_OAM + 70)
	ld	(hl), c
;numbers.c:88: set_sprite_tile(18, SkateArray[5]);
	ld	hl, #(_SkateArray + 10)
	ld	c, (hl)
;C:/Users/rutha/Documents/GitHub/something_stupid/gbdk/include/gb/gb.h:1447: shadow_OAM[nb].tile=tile;
	ld	hl, #(_shadow_OAM + 74)
...
;numbers.c:90: case 4:
00105$:
;numbers.c:91: set_sprite_tile(14, SkateArray[0]);
	ld	hl, #_SkateArray
	ld	c, (hl)
;C:/Users/rutha/Documents/GitHub/something_stupid/gbdk/include/gb/gb.h:1447: shadow_OAM[nb].tile=tile;
	ld	hl, #(_shadow_OAM + 58)
	ld	(hl), c
;numbers.c:92: set_sprite_tile(15, SkateArray[1]);
	ld	hl, #_SkateArray + 2
	ld	c, (hl)
;C:/Users/rutha/Documents/GitHub/something_stupid/gbdk/include/gb/gb.h:1447: shadow_OAM[nb].tile=tile;
	ld	hl, #(_shadow_OAM + 62)
	ld	(hl), c
;numbers.c:93: set_sprite_tile(16, SkateArray[2]);
	ld	hl, #_SkateArray + 4
	ld	c, (hl)
;C:/Users/rutha/Documents/GitHub/something_stupid/gbdk/include/gb/gb.h:1447: shadow_OAM[nb].tile=tile;
	ld	hl, #(_shadow_OAM + 66)
	ld	(hl), c
;numbers.c:94: set_sprite_tile(17, SkateArray[3]);
	ld	hl, #_SkateArray + 6
	ld	c, (hl)
;C:/Users/rutha/Documents/GitHub/something_stupid/gbdk/include/gb/gb.h:1447: shadow_OAM[nb].tile=tile;
	ld	hl, #(_shadow_OAM + 70)
	ld	(hl), c
;numbers.c:95: set_sprite_tile(18, SkateArray[5]);
	ld	hl, #_SkateArray + 10
	ld	c, (hl)
;C:/Users/rutha/Documents/GitHub/something_stupid/gbdk/include/gb/gb.h:1447: shadow_OAM[nb].tile=tile;
	ld	hl, #(_shadow_OAM + 74)
...
;numbers.c:97: case 5:
00106$:
;numbers.c:98: set_sprite_tile(14, SkateArray[0]);
	ld	hl, #_SkateArray
	ld	c, (hl)
;C:/Users/rutha/Documents/GitHub/something_stupid/gbdk/include/gb/gb.h:1447: shadow_OAM[nb].tile=tile;
	ld	hl, #(_shadow_OAM + 58)
	ld	(hl), c
;numbers.c:99: set_sprite_tile(15, SkateArray[1]);
	ld	hl, #_SkateArray + 2
	ld	c, (hl)
;C:/Users/rutha/Documents/GitHub/something_stupid/gbdk/include/gb/gb.h:1447: shadow_OAM[nb].tile=tile;
	ld	hl, #(_shadow_OAM + 62)
	ld	(hl), c
;numbers.c:100: set_sprite_tile(16, SkateArray[2]);
	ld	hl, #_SkateArray + 4
	ld	c, (hl)
;C:/Users/rutha/Documents/GitHub/something_stupid/gbdk/include/gb/gb.h:1447: shadow_OAM[nb].tile=tile;
	ld	hl, #(_shadow_OAM + 66)
	ld	(hl), c
;numbers.c:101: set_sprite_tile(17, SkateArray[3]);
	ld	hl, #_SkateArray + 6
	ld	c, (hl)
;C:/Users/rutha/Documents/GitHub/something_stupid/gbdk/include/gb/gb.h:1447: shadow_OAM[nb].tile=tile;
	ld	hl, #(_shadow_OAM + 70)
	ld	(hl), c
;numbers.c:102: set_sprite_tile(18, SkateArray[4]);
	ld	hl, #_SkateArray + 8
	ld	c, (hl)
;C:/Users/rutha/Documents/GitHub/something_stupid/gbdk/include/gb/gb.h:1447: shadow_OAM[nb].tile=tile;
	ld	hl, #(_shadow_OAM + 74)
...
;numbers.c:105: }
	ret
;states.c:78: void LoadMusic(const unsigned char * MusicData[], int loop, int speed)
;	---------------------------------
; Function LoadMusic
; ---------------------------------
_LoadMusic::
;C:/Users/rutha/Documents/GitHub/something_stupid/gbdk/include/gb/gb.h:671: __asm__("di");
	di
;states.c:83: gbt_play(MusicData, 2, speed);
	ldhl	sp,	#6
	ld	a, (hl)
	ldhl	sp,	#2
	ld	c, (hl)
...
_PickupXArray:
	...
	.dw #0x0078
	.dw #0x0032
;states.c:93: int GameState() //Main Game state 
;	---------------------------------
; Function GameState
; ---------------------------------
_GameState::
	add	sp, #-4
;states.c:97: switch(joypad()){
	call	_joypad
	ld	l, e
;	spillPairReg hl
;	spillPairReg hl
;states.c:101: MarkerSpeed -= 15;
	push	hl
	ld	hl, #_MarkerSpeed
	ld	b, (hl)
	pop	hl
...
;states.c:97: switch(joypad()){
	...
	jr	Z, 00104$
	jr	00113$
;states.c:98: case J_LEFT: 
00101$:
;states.c:99: if(ButtonPressed == 0){
	ld	a, (#_ButtonPressed)
	or	a, a
	jr	NZ, 00114$
;states.c:100: MarkerDirection = -1;
...
;states.c:101: MarkerSpeed -= 15;
	...
	ld	(hl+), a
	ld	(hl), b
;states.c:103: ButtonPressed = 1;
	ld	hl, #_ButtonPressed
	ld	(hl), #0x01
;states.c:105: break;
	jr	00114$
;states.c:106: case J_B: 
00104$:
;states.c:107: if(ButtonPressed == 0){
	ld	a, (#_ButtonPressed)
	or	a, a
	jr	NZ, 00114$
;states.c:108: MarkerDirection = -1;
	ld	hl, #_MarkerDirection
	ld	(hl), #0xff
;states.c:109: MarkerSpeed -= 15;
	ld	hl, #_MarkerSpeed
	ld	a, c
	ld	(hl+), a
	ld	(hl), b
;states.c:111: ButtonPressed = 1;
	ld	hl, #_ButtonPressed
	ld	(hl), #0x01
;states.c:113: break;
	jr	00114$
;states.c:114: case J_RIGHT: 
00107$:
;states.c:115: if(ButtonPressed == 0){
	ld	a, (#_ButtonPressed)
	or	a, a
	jr	NZ, 00114$
;states.c:116: MarkerDirection = 1;
	ld	hl, #_MarkerDirection
	ld	(hl), #0x01
;states.c:117: MarkerSpeed += 15;
	ld	hl, #_MarkerSpeed
	...
	ld	(hl+), a
	ld	(hl), d
;states.c:119: ButtonPressed = 1;
	ld	hl, #_ButtonPressed
	ld	(hl), #0x01
;states.c:121: break;
	jr	00114$
;states.c:122: case J_A: 
00110$:
;states.c:123: if(ButtonPressed == 0){
	ld	a, (#_ButtonPressed)
	or	a, a
	jr	NZ, 00114$
;states.c:124: MarkerDirection = 1;
	ld	hl, #_MarkerDirection
	ld	(hl), #0x01
;states.c:125: MarkerSpeed += 15;
	ld	hl, #_MarkerSpeed
	ld	a, e
	ld	(hl+), a
	ld	(hl), d
;states.c:127: ButtonPressed = 1;
	ld	hl, #_ButtonPressed
	ld	(hl), #0x01
;states.c:129: break;
	jr	00114$
;states.c:130: default:
00113$:
;states.c:131: ButtonPressed = 0;
	ld	hl, #_ButtonPressed
	ld	(hl), #0x00
;states.c:133: }
00114$:
;states.c:144: MarkerSpeed += difficultyInfluence[score4] * MarkerDirection;
...
;	spillPairReg hl
	...
	ld	(hl), c
	inc	hl
;states.c:145: if(MarkerSpeed > 50 ){
	ld	(hl-), a
	ld	a, (hl+)
	ld	c, a
	ld	b, (hl)
...
;states.c:146: MarkerSpeed = 50;
	...
	ld	(hl), a
00116$:
;states.c:148: if(MarkerSpeed < -50 ){
	ld	hl, #_MarkerSpeed
	ld	a, (hl+)
	sub	a, #0xce
	ld	a, (hl)
...
00250$:
	jr	NC, 00118$
;states.c:149: MarkerSpeed = -50;
	ld	hl, #_MarkerSpeed
	ld	a, #0xce
	ld	(hl+), a
	ld	(hl), #0xff
00118$:
;states.c:152: MarkerPos += MarkerSpeed;
	ld	hl, #_MarkerSpeed
	ld	a, (hl+)
	ld	c, a
	ld	b, (hl)
	...
	ld	a, (hl)
	adc	a, b
;states.c:155: if (MarkerPos>>4 > 108)
	ld	(hl-), a
	ld	a, (hl+)
	ld	c, a
	ld	b, (hl)
	...
	sbc	a, b
	jr	NC, 00123$
;states.c:157: SetSpriteIndex(&SkaterBoi, 2);
	ld	a, #0x02
	push	af
	inc	sp
	ld	de, #_SkaterBoi
	...
	call	_SetSpriteIndex
	add	sp, #3
;states.c:158: PlayerPos+=PLAYERSPEED;
	ld	hl, #_PlayerPos
	ld	a, (hl+)
	ld	c, a
	ld	a, (hl-)
...
;states.c:159: score1+=10;
	...
	jr	00124$
00123$:
;states.c:161: else if (MarkerPos>>4 > 56)
	ld	a, #0x38
	cp	a, c
	ld	a, #0x00
	sbc	a, b
	jr	NC, 00120$
;states.c:163: SetSpriteIndex(&SkaterBoi, 1);
	ld	a, #0x01
	push	af
	inc	sp
	ld	de, #_SkaterBoi
...
;states.c:164: score1+=5;
	...
	jr	00124$
00120$:
;states.c:168: SetSpriteIndex(&SkaterBoi, 0);
	xor	a, a
	push	af
	inc	sp
	ld	de, #_SkaterBoi
	...
	call	_SetSpriteIndex
	add	sp, #3
;states.c:169: PlayerPos-=PLAYERSPEED;
	ld	hl, #_PlayerPos
	ld	a, (hl+)
	ld	c, a
	ld	a, (hl-)
...
;states.c:176: score2++;
	...
	inc	(hl)
00126$:
;states.c:178: if(score2 >= 10){
	ld	hl, #_score2
	ld	a, (hl)
	sub	a, #0x0a
	jr	C, 00128$
;states.c:179: score2 = 0;
	ld	(hl), #0x00
;states.c:180: score3++;
	ld	hl, #_score3
	inc	(hl)
00128$:
;states.c:182: if(score3 >= 10){
	ld	hl, #_score3
	ld	a, (hl)
	sub	a, #0x0a
	jr	C, 00130$
;states.c:183: score3 = 0;
	ld	(hl), #0x00
;states.c:184: score4++; 
	ld	hl, #_score4
	inc	(hl)
00130$:
;states.c:188: if(MarkerPos>>4 > 157){
	ld	hl, #_MarkerPos
	ld	a, (hl+)
	ld	c, a
	ld	b, (hl)
	...
	sbc	a, b
	jr	NC, 00132$
;states.c:189: GotoFailState = 1;
	ld	hl, #_GotoFailState
	ld	(hl), #0x01
;states.c:190: MarkerPos = 157 << 4;
	ld	hl, #_MarkerPos
	ld	a, #0xd0
	ld	(hl+), a
	ld	(hl), #0x09
;states.c:191: SetSpriteIndex(&SkaterBoi, 4);
	ld	a, #0x04
	push	af
	inc	sp
	ld	de, #_SkaterBoi
	...
	add	sp, #3
00132$:
;states.c:194: if(MarkerPos>>4 < 11){
	ld	hl, #_MarkerPos
	ld	a, (hl+)
	ld	c, a
	ld	b, (hl)
	...
	sbc	a, #0x00
	jr	NC, 00134$
;states.c:195: GotoFailState = 1;
	ld	hl, #_GotoFailState
	ld	(hl), #0x01
;states.c:196: MarkerPos = 11 << 4;
	ld	hl, #_MarkerPos
	ld	a, #0xb0
	ld	(hl+), a
	xor	a, a
	ld	(hl), a
;states.c:197: SetSpriteIndex(&SkaterBoi, 3);
	ld	a, #0x03
	push	af
	inc	sp
	ld	de, #_SkaterBoi
	...
	add	sp, #3
00134$:
;states.c:201: if(PlayerPos>>4 < PickupXArray[PickupNumber] && PlayerPos>>4 > PickupXArray[PickupNumber]-16)
	ld	hl, #_PlayerPos
	ld	a, (hl+)
	ld	c, a
	ld	b, (hl)
...
;	spillPairReg hl
	...
	sbc	a, b
	jr	NC, 00136$
;states.c:204: score4 += 1;
	ld	hl, #_score4
	inc	(hl)
;states.c:205: PickupNumber++;
	ld	hl, #_PickupNumber
	inc	(hl)
;states.c:206: ChangeSkatePickupSprite(PickupNumber);
	ld	c, (hl)
	ld	b, #0x00
	push	bc
	call	_ChangeSkatePickupSprite
	pop	hl
;states.c:207: SkateDisplayShowNext(PickupNumber);
	ld	hl, #_PickupNumber
	ld	c, (hl)
	ld	b, #0x00
	push	bc
	call	_SkateDisplayShowNext
	pop	hl
00136$:
;states.c:212: SetSkaterBoiPos(&SkaterBoi, PlayerPos>>4, 101); // 70 - 90 
	ld	hl, #_PlayerPos
	ld	a, (hl+)
	ld	b, a
	ld	c, (hl)
	...
	add	sp, #4
;states.c:213: UpdateLevelScore(score1>>4, score2, score3, score4);
	ld	hl, #_score4
	ld	c, (hl)
	ld	b, #0x00
	ld	a, (#_score3)
	...
	add	sp, #8
;states.c:214: SetBalanceArrowPos(&BalanceArrow, MarkerPos >> 4, 125); // 11 - 157
	ld	hl, #_MarkerPos
	ld	a, (hl+)
	ld	b, a
	ld	c, (hl)
	...
	call	_SetBalanceArrowPos
	add	sp, #4
;states.c:215: MoveSkatePickupSprite(PickupXArray[PickupNumber],  116);
	ld	hl, #_PickupNumber
	ld	l, (hl)
;	spillPairReg hl
;	spillPairReg hl
...
;	spillPairReg hl
	...
	add	sp, #4
;states.c:217: if(GotoFailState == 1){
	ld	a, (#_GotoFailState)
	dec	a
	jr	NZ, 00139$
;states.c:218: return GAMESTATELOADFAIL;
	ld	de, #0x0008
	jr	00141$
00139$:
;states.c:220: return GAMESTATE;
	ld	de, #0x0004
00141$:
;states.c:224: }
	add	sp, #4
	ret
;states.c:230: int SplashLoadState()
;	---------------------------------
...
; ---------------------------------
_SplashState::
;states.c:237: return SPLASHSTATE;
	ld	de, #0x0000
;states.c:238: }
	ret
;states.c:240: int MenuLoadState()
;	---------------------------------
; Function MenuLoadState
; ---------------------------------
_MenuLoadState::
;states.c:242: set_bkg_data(0, 148, Manual_Manny_data);
	...
	call	_set_bkg_data
	add	sp, #4
;states.c:243: set_bkg_tiles(0, 0, 20, 18, Manual_Manny_map);
	...
	call	_set_bkg_tiles
	add	sp, #6
;states.c:245: LoadMusic(ManualStart_Data, 1, 7);
	ld	de, #0x0007
	push	de
	ld	de, #0x0001
	push	de
	...
	call	_LoadMusic
	add	sp, #6
;states.c:247: SHOW_BKG;
	ldh	a, (_LCDC_REG + 0)
	or	a, #0x01
	ldh	(_LCDC_REG + 0), a
;states.c:248: return MENUSTATE;
	ld	de, #0x0002
;states.c:249: }
	ret
;states.c:251: int MenuState() // State 0 
;	---------------------------------
; Function MenuState
; ---------------------------------
_MenuState::
;states.c:253: switch(joypad())
	call	_joypad
	ld	a, e
	sub	a, #0x80
	jr	NZ, 00102$
;states.c:256: return GAMESTATELOAD;
	ld	de, #0x0005
	ret
;states.c:258: }
00102$:
;states.c:259: return MENUSTATE;
	ld	de, #0x0002
;states.c:260: }
	ret
;states.c:262: int GameLoadState() // State 2 
;	---------------------------------
; Function GameLoadState
; ---------------------------------
_GameLoadState::
;states.c:264: set_bkg_data(0, 154, Manual_data);
	ld	de, #_Manual_data
	push	de
	ld	hl, #0x9a00
	push	hl
	call	_set_bkg_data
	add	sp, #4
;states.c:265: set_bkg_tiles(0, 0, 20, 18, Manual_map);
	ld	de, #_Manual_map
	push	de
	ld	hl, #0x1214
	push	hl
	...
	call	_set_bkg_tiles
	add	sp, #6
;states.c:267: LoadMusic(ThemeSong_Data, 1, 7);
	ld	de, #0x0007
	push	de
	ld	de, #0x0001
	push	de
	...
	call	_LoadMusic
	add	sp, #6
;states.c:269: MarkerPos = MANUALBARCENTER << 4;
	ld	hl, #_MarkerPos
	ld	a, #0x40
	ld	(hl+), a
	ld	(hl), #0x05
;states.c:270: PlayerPos = SKATERCENTER << 4;
	ld	hl, #_PlayerPos
	xor	a, a
	ld	(hl+), a
	ld	(hl), #0x05
;states.c:271: MarkerDirection = randomDir();
	call	_randomDir
	ld	hl, #_MarkerDirection
	ld	(hl), e
;states.c:272: ButtonPressed = 0;
	ld	hl, #_ButtonPressed
	ld	(hl), #0x00
;states.c:273: score1 = 0;
	xor	a, a
	ld	hl, #_score1
	ld	(hl+), a
	ld	(hl), a
;states.c:274: score2 = 0;
	ld	hl, #_score2
	ld	(hl), #0x00
;states.c:275: score3 = 0;
	ld	hl, #_score3
	ld	(hl), #0x00
;states.c:276: score4 = 0;
	ld	hl, #_score4
	ld	(hl), #0x00
;states.c:277: PickupNumber = 0;
	ld	hl, #_PickupNumber
;states.c:278: ChangeSkatePickupSprite(0);
	ld	de, #0x0000
	ld	(hl), e
	push	de
	call	_ChangeSkatePickupSprite
	pop	hl
;states.c:281: set_sprite_data(0, 21, SpriteData);
	ld	de, #_SpriteData
	push	de
	ld	hl, #0x1500
	push	hl
	...
	add	sp, #4
;states.c:282: set_sprite_data(21, 12, SkaterFailSpriteData);
	...
	call	_set_sprite_data
	add	sp, #4
;states.c:283: set_sprite_data(33, 15, NumbersData);
	ld	de, #_NumbersData
	push	de
	ld	hl, #0xf21
	push	hl
	call	_set_sprite_data
	add	sp, #4
;states.c:285: InitSkaterBoi(&SkaterBoi);
	ld	de, #_SkaterBoi
	push	de
	call	_InitSkaterBoi
	pop	hl
;states.c:286: InitBalanceArrow(&BalanceArrow);
	ld	de, #_BalanceArrow
	push	de
	call	_InitBalanceArrow
	pop	hl
;states.c:287: InitSkatePickupSprite();
	call	_InitSkatePickupSprite
;states.c:288: InitLevelScore();
	call	_InitLevelScore
;states.c:289: InitSkateDisplay();
	call	_InitSkateDisplay
;states.c:290: SkateDisplayShowNext(0);
	ld	de, #0x0000
	push	de
	call	_SkateDisplayShowNext
	pop	hl
;states.c:294: SHOW_BKG;
	ldh	a, (_LCDC_REG + 0)
	or	a, #0x01
	ldh	(_LCDC_REG + 0), a
;states.c:295: return GAMESTATE;
	ld	de, #0x0004
;states.c:296: }
	ret
;states.c:299: int GameResetState() // State 3  
;	---------------------------------
; Function GameResetState
; ---------------------------------
_GameResetState::
;states.c:301: LoadMusic(ThemeSong_Data, 1, 7);
	ld	de, #0x0007
	push	de
	ld	de, #0x0001
	push	de
	...
	call	_LoadMusic
	add	sp, #6
;states.c:303: MarkerPos = MANUALBARCENTER << 4;
	ld	hl, #_MarkerPos
	ld	a, #0x40
	ld	(hl+), a
	ld	(hl), #0x05
;states.c:304: PlayerPos = SKATERCENTER << 4;
	ld	hl, #_PlayerPos
	xor	a, a
	ld	(hl+), a
	ld	(hl), #0x05
;states.c:305: MarkerSpeed = 0; 
	xor	a, a
	ld	hl, #_MarkerSpeed
	ld	(hl+), a
	ld	(hl), a
;states.c:306: MarkerDirection = randomDir();
	call	_randomDir
	ld	hl, #_MarkerDirection
	ld	(hl), e
;states.c:307: ButtonPressed = 0;
	ld	hl, #_ButtonPressed
	ld	(hl), #0x00
;states.c:308: PickupNumber = 0;
	ld	hl, #_PickupNumber
;states.c:309: ChangeSkatePickupSprite(0);
	ld	de, #0x0000
	ld	(hl), e
	push	de
	call	_ChangeSkatePickupSprite
	pop	hl
;states.c:311: Counter = 0;
	ld	hl, #_Counter
	ld	(hl), #0x00
;states.c:312: GotoFailState = 0;
	ld	hl, #_GotoFailState
	ld	(hl), #0x00
;states.c:314: score1 = 0;
	xor	a, a
	ld	hl, #_score1
	ld	(hl+), a
	ld	(hl), a
;states.c:315: score2 = 0;
	ld	hl, #_score2
	ld	(hl), #0x00
;states.c:316: score3 = 0;
	ld	hl, #_score3
	ld	(hl), #0x00
;states.c:317: score4 = 0;
	ld	hl, #_score4
...
;states.c:319: }
	ret
;states.c:321: int GameLoadFailState()
;	---------------------------------
; Function GameLoadFailState
; ---------------------------------
_GameLoadFailState::
;states.c:323: LoadMusic(GameOver_Data, 2, 7);
	ld	de, #0x0007
	push	de
	ld	de, #0x0002
	push	de
	...
	call	_LoadMusic
	add	sp, #6
;states.c:324: return GAMESTATEFAIL;
	ld	de, #0x0006
;states.c:325: }
	ret
;states.c:327: int GameFailState()
;	---------------------------------
; Function GameFailState
; ---------------------------------
_GameFailState::
;states.c:329: FailStateTimer++;
	ld	hl, #_FailStateTimer
	inc	(hl)
;states.c:330: if (FailStateTimer > 100)
	ld	a, #0x64
	sub	a, (hl)
	jr	NC, 00102$
;states.c:332: LoadMusic(GameOver_Data, 0, 0);
	ld	de, #0x0000
	push	de
	push	de
	ld	de, #_GameOver_Data
	...
	add	sp, #6
00102$:
;states.c:334: switch(joypad()){
	call	_joypad
	ld	a, e
	sub	a, #0x80
	jr	NZ, 00104$
;states.c:336: FailStateTimer = 0;
	ld	hl, #_FailStateTimer
